...
describe('expo-module e2e', () => {
  ...
  beforeAll(() => {
    ensureNxProject('@react-universal/expo-module', 'dist/packages/expo-module');
  });
  ...
  it('should create expo-module', async () => {
  ...
  describe('--tags', () => {
    it('should add tags to the project', async () => {
      const projectName = uniq('expo-module');
      ensureNxProject('@react-universal/expo-module', 'dist/packages/expo-module');
      await runNxCommandAsync(
