...
const make = Effect.gen(function* () {
  ...
  //   }).pipe(
  //     Effect.scoped,
  //     // Effect.provide(typingsInstallerWorkerLayer)
  //   );
  // }
});
...
export const AppWorkersLive = Layer.scoped(AppWorkers, make).pipe(
  Layer.provideMerge(compilerWorkerLayer),
  traceLayerLogs('workers_svc'),
);
