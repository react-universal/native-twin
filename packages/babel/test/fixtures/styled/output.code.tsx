...
var _styled = _interopRequireDefault(require('@universal-labs/styled'));
var _jsxRuntime = require('react/jsx-runtime');
(0, _nativeTwin.setup)(
  (0, _nativeTwin.defineConfig)({ presets: [(0, _presetTailwind.presetTailwind)()] }),
);
var CustomView = _styled.default.View`flex-1`;
var Main = function Main() {
  var _useState = (0, _react.useState)({ backgroundColor: 'back' }),
    _useState2 = (0, _slicedToArray2.default)(_useState, 2),
    state = _useState2[0],
    dispatch = _useState2[1];
  return (0, _jsxRuntime.jsx)(CustomView, { className: 'bg-gray-200', style: state });
};
exports.Main = Main;