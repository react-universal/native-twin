import { ParseSelectorStrict } from '../src/css/parser/selector.parser';
...
describe.skip('CSS - FlexBox', () => {
  ...
  test('flex direction row-reverse', () => {
    ...
    expect(flexRowReverse).toStrictEqual({
  ...
  test('flex direction col-reverse', () => {
    ...
    expect(flexColReverse).toStrictEqual({
...
describe.skip('@native-twin/css Spaces', () => {
  ...
  it('p-[1vw]', () => {
    ...
    expect(result).toStrictEqual({ padding: 7.2 });
  });

  it('aspect-square', () => {
    const result = generateStylesFor('aspect-square');

    expect(result).toStrictEqual({ aspectRatio: 1 });
  });

  it('m-[10vh]', () => {
    const result = generateStylesFor('m-[10vh]');

    expect(result).toStrictEqual({ margin: 128 });
  });

  it('mt-[10%]', () => {
    const result = generateStylesFor('mt-[10%]');

    expect(result).toStrictEqual({ marginTop: '10%' });
  });
});
...
describe.skip('@native-twin/css Font', () => {
  ...
  it('font-sans', () => {
    ...
    expect(result).toStrictEqual({ fontFamily: 'ui-sans-serif' });
  });
});
...
describe.skip('@native-twin/css GAP', () => {
  it('gap', () => {
    ...
    expect(result).toStrictEqual({ gap: 8, columnGap: 8, rowGap: 8 });
  });
});
...
describe.skip('@native-twin/css Transform', () => {
  it('skew-x-1', () => {
    ...
    expect(result).toStrictEqual({ transform: [{ skewX: '1deg' }] });
  });
  ...
  it('rotate-[1.2turn]', () => {
    ...
    expect(result).toStrictEqual({ transform: [{ rotate: '432deg' }] });
  });

  it('rotate-x-[10rad]', () => {
    const result = generateStylesFor('rotate-x-[10rad]');

    expect(result).toStrictEqual({ transform: [{ rotate: '10rad' }] });
  });
});
