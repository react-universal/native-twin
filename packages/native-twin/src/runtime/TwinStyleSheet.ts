...
import { type ComponentStyleRegistry, EMPTY_RN_STYLES, emptyComponent } from './sheet/Models';
import { NativeTwinProcessor } from './sheet/TwinProcessor';
import { mergeComponentStyledProps, mergeStyles } from './sheet/utils';
...
export abstract class StyleSheetAdapter<Theme extends __Theme__ = __Theme__> {
  ...
  private _processor: NativeTwinProcessor;
  // private _components = createMapRegistry<TwinRuntimeComponent>();
  ...
  getComponentStyledProps(
    ...
    return mergeComponentStyledProps(styles, options.withPointer, options.withGroup);
  }
