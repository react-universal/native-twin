...
>
      <View
        className={`
          ...
          bg-red-500
        `}
        debug isFirstChild={true} ord={0} _twinComponentID="/fixtures/code.tsx-1205-1931-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-1205-1931-View",[
      ...
      >
        ...
        <View className='bg-white shadow-md rounded-xl p-2' ord={1} _twinComponentID="/fixtures/code.tsx-5580-5854-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-5580-5854-View",[
...
>
          <Text
            ...
            `} isFirstChild={true} ord={0} _twinComponentID="/fixtures/code.tsx-6964-7179-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-6964-7179-Text",[
      ...
      <View
        ...
        `} ord={1} _twinComponentID="/fixtures/code.tsx-8631-9930-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-8631-9930-View",[
      ...
      >
        <Text
          ...
          `} isFirstChild={true} ord={0} _twinComponentID="/fixtures/code.tsx-10272-10499-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-10272-10499-Text",[
                  ...
                  ,]
                      ...
                      id: "/fixtures/code.tsx-10272-10499-Text",
                      target: "style",
                      prop: "className",
                  }
                  ,]}
        ...
        <Pressable
          ...
          }} ord={1} _twinComponentID="/fixtures/code.tsx-12020-12229-Pressable" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-12020-12229-Pressable",[

                  ]
                  )} _twinComponentTemplateEntries={[]}

        >
          <Text className='text-gray-200  text-3xl' isFirstChild={true} ord={0} _twinComponentID="/fixtures/code.tsx-12412-12497-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-12412-12497-Text",[
...
>Activate</Text>
        ...
        <Image
          ...
          style={{
            width: 100,
            height: 100,
          }} ord={2} isLastChild={true} _twinComponentID="/fixtures/code.tsx-13460-13749-Image" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-13460-13749-Image",[
        ...
        <View
          ...
          `}
          debug ord={4} _twinComponentID="/fixtures/code.tsx-15161-15578-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-15161-15578-View",[
        ...
        >
          <Text
            ...
            className='font-inter-bold rotate-6 text-2xl text-gray-800 group-hover:text-white -mt-2' isFirstChild={true} ord={0} _twinComponentID="/fixtures/code.tsx-17116-17345-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-17116-17345-Text",[
