...
function HomeScreen() {
  ...
  return (
    <View className='flex-1 bg-red' _twinComponentID="/fixtures/code.tsx-352-2399-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-352-2399-View",[
...
>
      <View
        className={`
          ...
          bg-red-500
        `}
        debug isFirstChild="{true}" ord="{0}" _twinComponentID="/fixtures/code.tsx-1205-1935-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-1205-1935-View",[
      ...
      >
        ...
        <View className='bg-white shadow-md rounded-xl p-2' ord="{1}" _twinComponentID="/fixtures/code.tsx-5588-5864-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-5588-5864-View",[
...
>
          <Text
            ...
            `} isFirstChild="{true}" ord="{0}" _twinComponentID="/fixtures/code.tsx-6974-7193-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-6974-7193-Text",[
      ...
      <View
        ...
        `} ord="{1}" _twinComponentID="/fixtures/code.tsx-8645-9946-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-8645-9946-View",[
      ...
      >
        <Text
          ...
          `} isFirstChild="{true}" ord="{0}" _twinComponentID="/fixtures/code.tsx-10288-10519-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-10288-10519-Text",[
                  ...
                  ,]
                      ...
                      id: "/fixtures/code.tsx-10288-10519-Text",
                      target: "style",
                      prop: "className",
                  }
                  ,]}
        ...
        <Pressable
          ...
          }} ord="{1}" _twinComponentID="/fixtures/code.tsx-12040-12251-Pressable" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-12040-12251-Pressable",[

                  ]
                  )} _twinComponentTemplateEntries={[]}

        >
          <Text className='text-gray-200  text-3xl' isFirstChild="{true}" ord="{0}" _twinComponentID="/fixtures/code.tsx-12434-12523-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-12434-12523-Text",[
...
>Activate</Text>
        ...
        <Image
          ...
          style={{
            width: 100,
            height: 100,
          }} ord="{2}" isLastChild="{true}" _twinComponentID="/fixtures/code.tsx-13486-13779-Image" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-13486-13779-Image",[
        ...
        <View
          ...
          `}
          debug ord="{4}" _twinComponentID="/fixtures/code.tsx-15193-15612-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-15193-15612-View",[
        ...
        >
          <Text
            ...
            className='font-inter-bold rotate-6 text-2xl text-gray-800 group-hover:text-white -mt-2' isFirstChild="{true}" ord="{0}" _twinComponentID="/fixtures/code.tsx-17150-17383-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("/fixtures/code.tsx-17150-17383-Text",[
