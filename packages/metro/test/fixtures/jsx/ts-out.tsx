...
function HomeScreen() {
  ...
  return (
    <View className='flex-1 bg-red' _twinComponentID="fixtures/code.tsx-352-2435-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-352-2435-View",[
...
>
      <View
        className={`
          ...
          bg-red-500
        `}
        debug isFirstChild={true} ord={0} _twinComponentID="fixtures/code.tsx-1203-1965-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-1203-1965-View",[
      ...
      >
        ...
        <View className='bg-white shadow-md rounded-xl p-2' ord={1} _twinComponentID="fixtures/code.tsx-5576-5878-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-5576-5878-View",[
...
>
          <Text
            ...
            `} isFirstChild={true} ord={0} _twinComponentID="fixtures/code.tsx-6958-7173-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-6958-7173-Text",[
      ...
      <View
        ...
        `} ord={1} _twinComponentID="fixtures/code.tsx-8623-10001-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-8623-10001-View",[
      ...
      >
        <Text
          ...
          `} isFirstChild={true} ord={0} _twinComponentID="fixtures/code.tsx-10264-10491-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-10264-10491-Text",[
                  ...
                  ,]
                      ...
                      id: "fixtures/code.tsx-10264-10491-Text",
                      target: "style",
                      prop: "className",
                  }
                  ,]}
        ...
        <Pressable
          ...
          }} ord={1} _twinComponentID="fixtures/code.tsx-12009-12246-Pressable" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-12009-12246-Pressable",[

                  ]
                  )} _twinComponentTemplateEntries={[]}

        >
          <Text className='text-gray-200  text-3xl' isFirstChild={true} ord={0} _twinComponentID="fixtures/code.tsx-12399-12484-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-12399-12484-Text",[
...
>Activate</Text>
        ...
        <Image
          ...
          style={{
            width: 100,
            height: 100,
          }} ord={2} isLastChild={true} _twinComponentID="fixtures/code.tsx-13445-13734-Image" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-13445-13734-Image",[
        ...
        <View
          ...
          `}
          debug ord={4} _twinComponentID="fixtures/code.tsx-15144-15589-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-15144-15589-View",[
        ...
        >
          <Text
            ...
            className='font-inter-bold rotate-6 text-2xl text-gray-800 group-hover:text-white -mt-2' isFirstChild={true} ord={0} _twinComponentID="fixtures/code.tsx-17097-17326-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-17097-17326-Text",[
