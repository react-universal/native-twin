...
>
      <View
        className={`
          ...
          bg-red-500
        `}
        debug isFirstChild={true} ord={0} _twinComponentID="fixtures/code.tsx-1168-1930-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-1168-1930-View",[
      ...
      >
        ...
        <View className='bg-white shadow-md rounded-xl p-2' ord={1} _twinComponentID="fixtures/code.tsx-5506-5808-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-5506-5808-View",[
...
>
          <Text
            ...
            `} isFirstChild={true} ord={0} _twinComponentID="fixtures/code.tsx-6853-7068-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-6853-7068-Text",[
      ...
      <View
        ...
        `} ord={1} _twinComponentID="fixtures/code.tsx-8483-9861-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-8483-9861-View",[
      ...
      >
        <Text
          ...
          `} isFirstChild={true} ord={0} _twinComponentID="fixtures/code.tsx-10087-10314-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-10087-10314-Text",[
        ...
        <Pressable
          ...
          }} ord={1} _twinComponentID="fixtures/code.tsx-11382-11619-Pressable" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-11382-11619-Pressable",[

                  ]
                  )}

        >
          <Text className='text-gray-200  text-3xl' isFirstChild={true} ord={0} _twinComponentID="fixtures/code.tsx-11737-11822-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-11737-11822-Text",[
...
>Activate</Text>
        ...
        <Image
          ...
          style={{
            width: 100,
            height: 100,
          }} ord={2} isLastChild={true} _twinComponentID="fixtures/code.tsx-12748-13037-Image" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-12748-13037-Image",[
        ...
        <View
          ...
          `}
          debug ord={4} _twinComponentID="fixtures/code.tsx-14412-14857-View" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-14412-14857-View",[
        ...
        >
          <Text
            ...
            className='font-inter-bold rotate-6 text-2xl text-gray-800 group-hover:text-white -mt-2' isFirstChild={true} ord={0} _twinComponentID="fixtures/code.tsx-16330-16559-Text" _twinComponentSheet={require('@native-twin/jsx').StyleSheet.registerComponent("fixtures/code.tsx-16330-16559-Text",[
